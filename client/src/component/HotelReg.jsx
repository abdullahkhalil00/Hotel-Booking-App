...
hidden md:block'/>
                ...
                <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10 invert'>
...
right-4 h-4 w-4 cursor-pointer'/>
                    ...
                    <div className='w-full mt-4 max-w-60 mr-auto'>
                        ...
                        label>
                        <select id="city" className='className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light'
                            required>
